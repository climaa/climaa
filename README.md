...
**Agent orchestration.** I run three modes: *explore and plan* (no code written), *parallel* (small PRs I accept in review), and *autonomous* (overnight, accepted by the test pyramid). The principle underneath: agents write the code, but they never decide whether it ships. Authorship and acceptance stay separate.

### What you can open right now

Every link below is live, and all of them are built in the open in [`climaa/acceptance-gate`](https://github.com/climaa/acceptance-gate).

| | |
| --- | --- |
| [**carloslima.dev**](https://carloslima.dev) | Portfolio and CV — the work, and the numbers under it. |
| [**blog.carloslima.dev**](https://blog.carloslima.dev) | The argument: quality is a property of the pipeline, not a phase at the end. |
| [**storybook.carloslima.dev**](https://storybook.carloslima.dev) | The design system — tokens, atoms, molecules, accessibility checked. |
...
[carloslima.dev](https://carloslima.dev) · [LinkedIn](https://www.linkedin.com/in/carlos-lima-frontend) · dj.flypo@gmail.com
